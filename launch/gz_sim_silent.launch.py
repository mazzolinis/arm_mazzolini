# Copy of gazebo launch.py from gazebo_ros_pkgs
# In this case it's silent (info is set to log instead of screen)
...
def launch_gz(context, *args, **kwargs):
    ...
    exec_cmd = f"{exec} {exec_args} --force-version {gz_version} 2>/dev/null"
